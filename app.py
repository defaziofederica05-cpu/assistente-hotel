...
def main():
    ...
    if query:
        with st.spinner("Sto elaborando..."):
            ...
            # Altre funzionalità (camere libere, notti ospite, ricerca prenotazioni)
            st.info("❓ Domande possibili: ricavo mese, ricavo periodo, camere libere, notti ospite, ricerca prenotazioni.")
